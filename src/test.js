...
const pidController = new PIDController_1.PIDController(0.0, 0.8, 0.0, 1);
const charger = new EGoChargerCtl_1.EGoChargerCtl(nrPhases, minCurrent, essAccuThreshold, switchOnCurrent, pidController);
